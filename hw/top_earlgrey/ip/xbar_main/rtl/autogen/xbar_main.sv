...
module xbar_main (
  ...
  always_comb begin
    ...
    dev_sel_s1n_15 = 3'd4;
    if (((tl_s1n_15_us_h2d.a_address <= (ADDR_MASK_ROM + ADDR_SPACE_ROM)) &&
       (tl_s1n_15_us_h2d.a_address >= ADDR_SPACE_ROM))) begin
      dev_sel_s1n_15 = 3'd0;
  ...
  always_comb begin
    ...
    if (((tl_s1n_20_us_h2d.a_address <= (ADDR_MASK_ROM + ADDR_SPACE_ROM)) &&
       (tl_s1n_20_us_h2d.a_address >= ADDR_SPACE_ROM))) begin
      dev_sel_s1n_20 = 4'd0;
  ...
  always_comb begin
    ...
    if (((tl_s1n_30_us_h2d.a_address <= (ADDR_MASK_ROM + ADDR_SPACE_ROM)) &&
       (tl_s1n_30_us_h2d.a_address >= ADDR_SPACE_ROM))) begin
      dev_sel_s1n_30 = 4'd0;
