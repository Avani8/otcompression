...
HD_PWD='/home/test/opentitan/build/lowrisc_systems_top_earlgrey_nexysvideo_0.1/synth-vivado/lowrisc_systems_top_earlgrey_nexysvideo_0.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_earlgrey_nexysvideo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_earlgrey_nexysvideo.tcl -notrace
