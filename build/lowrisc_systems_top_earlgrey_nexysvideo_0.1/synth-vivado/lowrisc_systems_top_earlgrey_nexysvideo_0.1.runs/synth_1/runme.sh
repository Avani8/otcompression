...
HD_PWD='/home/test/opentitan/build/lowrisc_systems_top_earlgrey_nexysvideo_0.1/synth-vivado/lowrisc_systems_top_earlgrey_nexysvideo_0.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_earlgrey_nexysvideo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_earlgrey_nexysvideo.tcl
