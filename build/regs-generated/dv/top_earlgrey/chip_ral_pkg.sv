  ...
  class uart_reg_intr_state extends dv_base_reg;
    ...
    virtual function void build();
      ...
      rx_watermark.configure(
        ...
        .is_rand(1),
        .individually_accessible(1));
      tx_empty = dv_base_reg_field::type_id::create("tx_empty");
      tx_empty.configure(
        .parent(this),
        .size(1),
        .lsb_pos(2),
...
package aes_ral_pkg;
  ...
  class aes_reg_trigger extends dv_base_reg;
    ...
    rand dv_base_reg_field data_in_clear;
    ...
    virtual function void build();
      ...
      key_clear.configure(
        ...
        .is_rand(1),
        .individually_accessible(1));
      data_in_clear = dv_base_reg_field::type_id::create("data_in_clear");
      data_in_clear.configure(
        .parent(this),
        .size(1),
        .lsb_pos(2),
        .access("WO"),
...
package chip_ral_pkg;
  ...
  import pinmux_ral_pkg::*;
  import rv_timer_ral_pkg::*;
  import rv_plic_ral_pkg::*;
  import aes_ral_pkg::*;
  import hmac_ral_pkg::*;
  import alert_handler_ral_pkg::*;
  import nmi_gen_ral_pkg::*;
